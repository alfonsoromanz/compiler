#############################################################################
# Makefile for building: CompiladorQT
# Generated by qmake (3.1) (Qt 6.6.0)
# Project:  CompiladorQT.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile CompiladorQT.pro
#############################################################################
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.0.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.0.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/local/lib/QtCore.framework/Headers -I. -I/usr/local/share/qt/mkspecs/macx-clang -F/usr/local/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CompiladorQT1.0.0
DISTDIR = /Users/alfonso/Projects/compiler/.tmp/CompiladorQT1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.0.sdk -mmacosx-version-min=13.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
LIBS          = $(SUBLIBS) -F/usr/local/lib -framework QtCore -framework IOKit -framework DiskArbitration   
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/clang-mac.conf \
		...
		CompiladorQT.pro AnalizadorLexico.h \
		EntradaTS.h \
		TabladeSimbolos.h \
		y.tab.h \
		Parser.h \
		GeneradorDeCodigo.h main.cpp \
		AnalizadorLexico.cpp \
		EntradaTS.cpp \
		TabladeSimbolos.cpp \
		Parser.cpp \
		GeneradorDeCodigo.cpp
QMAKE_TARGET  = CompiladorQT
DESTDIR       = 
TARGET        = CompiladorQT
...
EXPORT__PRO_FILE_ = /Users/alfonso/Projects/compiler/CompiladorQT.pro


include /usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

CompiladorQT:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: CompiladorQT.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.6.0/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile CompiladorQT.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents AnalizadorLexico.h EntradaTS.h TabladeSimbolos.h y.tab.h Parser.h GeneradorDeCodigo.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp AnalizadorLexico.cpp EntradaTS.cpp TabladeSimbolos.cpp y.tab.c Parser.cpp GeneradorDeCodigo.cpp $(DISTDIR)/
...
main.o: main.cpp TabladeSimbolos.h \
...
AnalizadorLexico.o: AnalizadorLexico.cpp AnalizadorLexico.h \
		...
		/usr/local/lib/QtCore.framework/Headers/qvector.h \
		y.tab.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AnalizadorLexico.o AnalizadorLexico.cpp

EntradaTS.o: EntradaTS.cpp EntradaTS.h \
		/usr/local/lib/QtCore.framework/Headers/QString \
		/usr/local/lib/QtCore.framework/Headers/qstring.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EntradaTS.o EntradaTS.cpp

TabladeSimbolos.o: TabladeSimbolos.cpp TabladeSimbolos.h \
		/usr/local/lib/QtCore.framework/Headers/QString \
		/usr/local/lib/QtCore.framework/Headers/qstring.h \
		EntradaTS.h \
		/usr/local/lib/QtCore.framework/Headers/QMap \
		...
		/usr/local/lib/QtCore.framework/Headers/QVector \
		/usr/local/lib/QtCore.framework/Headers/qvector.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TabladeSimbolos.o TabladeSimbolos.cpp
...
GeneradorDeCodigo.o: GeneradorDeCodigo.cpp GeneradorDeCodigo.h \
		TabladeSimbolos.h \
		/usr/local/lib/QtCore.framework/Headers/QString \
		/usr/local/lib/QtCore.framework/Headers/qstring.h \
		EntradaTS.h \
		...
		/usr/local/lib/QtCore.framework/Headers/qlist.h \
		y.tab.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o GeneradorDeCodigo.o GeneradorDeCodigo.cpp
